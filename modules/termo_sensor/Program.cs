...
namespace AzureIotEdgeSimulatedTemperatureSensor
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Environment variable %EdgeHubConnectionString% is set to " + connectionString);
        ...
        static void InstallCert()
        {
            ...
            Console.WriteLine("Environment variable %EdgeModuleCACertificateFile% is set to " + certPath);
            ...
            {
                Console.WriteLine("Exception when InstallCert: " + err.Message);
            }
        }
